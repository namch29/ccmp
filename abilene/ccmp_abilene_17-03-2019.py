...
bkup_1="data-abilene-result-paths_backup1.txt"
bkup_2="data-abilene-result-paths_backup2.txt"
...
class ProjectCCMP(app_manager.RyuApp):
    ...
    #Begin 17-03
    def compile_java():
		subprocess.check_call(['javac', 'B.java'])
    def execute_java2():
		java_class,ext = os.path.splitext('B.java')
		#print java_class
		#print ext
		cmd = ['java', java_class]
    ...
    def _monitor(self):
		...
		"""
		hub.sleep(5)
		while (self.isInstallFlows==False):
			print "[====[Installing All Flows]======================>"
    ...
    def link_delete_handler(self, ev):
        ...
        if self.isReInstallFlows==False:
			...
			err_time = strftime("%a, %d %b %Y %H:%M:%S +0000", gmtime())
			print "\n.............................Backup flows were installing..................\n"
			self.install_flows(bkup_1)
			print "================ Backup flows were installed!! =============================\n"
			print err_time, '\n'
			
			#call Java 
			jar_file = 'NFVReliable.jar'
			agr1 = 'test'
			agr2 = 'data-abilene'
