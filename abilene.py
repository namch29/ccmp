...
def myNetwork():
	...
	#inputBW = 992
	#net.addLink(h1, s13, 	cls=TCLink, bw=inputBW)
	#net.addLink(h2, s14, 	cls=TCLink, bw=inputBW)
	#net.addLink(h3, s15, 	cls=TCLink, bw=inputBW)
	#net.addLink(h4, s16, 	cls=TCLink, bw=inputBW)
	#net.addLink(h5, s17, 	cls=TCLink, bw=inputBW)
	#net.addLink(h6, s18, 	cls=TCLink, bw=inputBW)
	
	#net.addLink(h7, s19, 	cls=TCLink, bw=inputBW)
	#net.addLink(h8, s20, 	cls=TCLink, bw=inputBW)
	#net.addLink(h9, s21, 	cls=TCLink, bw=inputBW)
	#net.addLink(h10, s22, 	cls=TCLink, bw=inputBW)
	#net.addLink(h11, s23, 	cls=TCLink, bw=inputBW)
	#net.addLink(h12, s24, 	cls=TCLink, bw=inputBW)
